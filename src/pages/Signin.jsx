...
import { setUserInfo } from "../Redux-Store/amazonSlice";
const Signin = () => {
  const auth = getAuth();
    ...
    if (email && password) {
      ...
      signInWithEmailAndPassword(auth, email, password)
        .then((userCredential) => {
          ...
          // console.log(user);
          setLoading(false);
          setSuccessMsg("Login Succesfull! Welcome Back");
          setTimeout(() => {
            navigate("/");
          }, 2000);
        })
        .catch((error) => {
          ...
          if (errorCode && errorCode.includes("auth/invalid-credential")) {
  ...
  return (
    <div className="w-full py-2">
      <div className="w-full bg-gray-100 pb-10 py-2 ">
        {successMsg ? (
